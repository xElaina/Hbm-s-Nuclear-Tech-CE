...
@AutoRegister
public class TileEntityRBMKGauge extends TileEntityLoadedBase implements ITickable, IGUIProvider, IControlReceiver, SimpleComponent, CompatHandler.OCComponent {
    ...
    public GuiScreen provideGUI(int ID, EntityPlayer player, World world, int x, int y, int z) {
        return new GUIScreenRBMKGauge(this);
    }
    ...
    public void receiveControl(NBTTagCompound data) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            gauge.color = MathHelper.clamp(data.getInteger("color" + i), 0, 0xffffff);
