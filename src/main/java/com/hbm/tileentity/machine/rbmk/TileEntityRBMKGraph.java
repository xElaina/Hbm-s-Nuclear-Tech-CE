...
@AutoRegister
public class TileEntityRBMKGraph extends TileEntityLoadedBase implements ITickable, IGUIProvider, IControlReceiver, SimpleComponent, CompatHandler.OCComponent {
	...
	@Override @SideOnly(Side.CLIENT) public GuiScreen provideGUI(int ID,EntityPlayer player,World world,int x,int y,int z) { return new GUIScreenRBMKGraph(this); }
