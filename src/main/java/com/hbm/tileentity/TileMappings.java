...
/**
 * Handle nbt structures te mappings from 1.7, basically a DataFixer
 */
public class TileMappings {
    // legacy id -> Class
    private static final HashMap<String, Class<? extends TileEntity>> map = new HashMap<>(512);
    private static final Logger LOGGER;
    private static final RegistryNamespaced<ResourceLocation, Class<? extends TileEntity>> REGISTRY;
    private static final MethodHandle setWorldCreateHandle = MethodHandleHelper.findVirtual(TileEntity.class, "setWorldCreate", "func_190201_b", MethodType.methodType(void.class, World.class));

    static {
        writeMappings();
        writeVanilla();
        try {
            MethodHandle tileEntityLoggerGetterHandle = MethodHandleHelper.findStaticGetter(TileEntity.class, "LOGGER", "field_145852_a", Logger.class);
            LOGGER = (Logger) tileEntityLoggerGetterHandle.invokeExact();
            MethodHandle tileEntityRegistryGetterHandle = MethodHandleHelper.findStaticGetter(TileEntity.class, "REGISTRY", "field_190562_f", RegistryNamespaced.class);
            //noinspection unchecked
            REGISTRY = (RegistryNamespaced<ResourceLocation, Class<? extends TileEntity>>) tileEntityRegistryGetterHandle.invokeExact();
...
//        put(TileEntityDecoSteelPoles.class, "tileentity_steelpoles");
        ...
        put(TileEntityDecoPoleSatelliteReceiver.class, "tileentity_satellitereceicer", "tileentity_deco_pole_satellite_receiver");
...
//        put(TileEntityFF.class, "tileentity_forcefield");
        ...
        put(TileEntityDeconRad.class, "tileentity_decon", "tileentity_decon_rad");//TileEntityDecon
        ...
        put(TileEntityBarrel.class, "tileentity_fluid_barrel", "tileentity_barrel");
...
//        put(TileEntityCustomMachine.class, "tileentity_custom_machine");
        ...
        put(BlockBobble.TileEntityBobble.class, "tileentity_ntm_bobblehead", "tileentity_bobble");
...
//        put(TileEntityEmitter.class, "tileentity_ntm_emitter");
        ...
        put(TileEntityWandLogic.class, "tileentity_wand_spawner", "tileentity_wand_logic");
...
//        }
    ...
    private static void writeVanilla() {
        map.put("FlowerPot", TileEntityFlowerPot.class);
    }

    private static void put(Class<? extends TileEntity> clazz, String name) {
        map.put(Tags.MODID + ":" + name, clazz);
    }
    ...
    public static TileEntity create(World worldIn, NBTTagCompound compound) {
        ...
        if (tileentity != null) {
            try {
                setWorldCreateHandle.invokeExact(tileentity, worldIn);
