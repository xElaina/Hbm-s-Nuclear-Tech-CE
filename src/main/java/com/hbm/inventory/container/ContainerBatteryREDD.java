...
public class ContainerBatteryREDD extends Container {
    ...
    public ContainerBatteryREDD(InventoryPlayer invPlayer, TileEntityBatteryREDD tedf) {
        ...
        this.addSlotToContainer(new SlotNonRetarded(socket.inventory, 0, 26, 53));
        this.addSlotToContainer(new SlotNonRetarded(socket.inventory, 1, 80, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index <= 1) {
                ...
                if (!this.mergeItemStack(stack, 0, 2, false)) return ItemStack.EMPTY;
            }
