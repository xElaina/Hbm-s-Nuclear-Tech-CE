...
public class MatDistribution extends SerializableRecipe {
    ...
    public void registerDefaults() {
        ...
        //actual ores
        //TODO:GTCEU check
        //mlbv: this can be done like this:
        MainRegistry.logger.info("GTCEu loaded = {}", Loader.isModLoaded("gregtech"));
        // mlbv: but for now I'll just keep it enabled for testing
...
//        }
        ...
        for (String ore : OreDictManager.TH232.all(MaterialShapes.ORE))
            registerOre(ore, MAT_THORIUM, INGOT.q(2), MAT_URANIUM, NUGGET.q(3), MAT_STONE, QUART.q(1));
    ...
    public Object getRecipeObject() {
        List<Entry<?, List<MaterialStack>>> entries = new ArrayList<>();
