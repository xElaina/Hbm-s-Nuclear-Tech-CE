...
public class ChemicalPlantRecipes extends GenericRecipes<GenericRecipe> {
    ...
    public void registerDefaults() {
        ...
        this.register(new GenericRecipe("chem.hydrogen").setupNamed(20, 400).setIcon(ModItems.gas_full, Fluids.HYDROGEN.getID())
                .inputItems(new RecipesCommon.OreDictStack(COAL.gem(), 1))
        ...
        this.register(new GenericRecipe("chem.hydrogencoke").setupNamed(20, 400).setIcon(ModItems.gas_full, Fluids.HYDROGEN.getID())
                .inputItems(new RecipesCommon.OreDictStack(ANY_COKE.gem(), 1))
                .inputFluids(new FluidStack(Fluids.WATER, 8_000))
                .outputFluids(new FluidStack(Fluids.HYDROGEN, 500)));
        ...
        this.register(new GenericRecipe("chem.helium3").setupNamed(200, 2_000).setIcon(ModItems.gas_full, Fluids.HELIUM3.getID())
                .inputItems(new RecipesCommon.ComparableStack(ModBlocks.moon_turf, 8))
        ...
        this.register(new GenericRecipe("chem.perfluoromethyl").setup(20, 100)
                .inputItems(new RecipesCommon.OreDictStack(F.dust()))
        ...
        this.register(new GenericRecipe("chem.biogas").setupNamed(60, 100).setIcon(ModItems.gas_full, Fluids.BIOGAS.getID())
                .inputItems(new RecipesCommon.ComparableStack(ModItems.biomass, 16))
        ...
        this.register(new GenericRecipe("chem.tarsand").setupNamed(200, 100).setIcon(ModBlocks.ore_oil_sand)
                .inputItems(new RecipesCommon.ComparableStack(ModBlocks.ore_oil_sand, 16), new RecipesCommon.OreDictStack(ANY_TAR.any(), 1))
        ...
        this.register(new GenericRecipe("chem.tel").setup(40, 100)
                .inputItems(new RecipesCommon.OreDictStack(ANY_TAR.any()), new RecipesCommon.OreDictStack(PB.dust()))
                .inputFluids(new FluidStack(Fluids.PETROLEUM, 100), new FluidStack(Fluids.STEAM, 1000))
                .outputItems(DictFrame.fromOne(ModItems.fuel_additive, ItemEnums.EnumFuelAdditive.ANTIKNOCK)));
        ...
        this.register(new GenericRecipe("chem.deicer").setup(40, 100)
                ...
                .outputItems(DictFrame.fromOne(ModItems.fuel_additive, ItemEnums.EnumFuelAdditive.DEICER)));
        ...
        this.register(new GenericRecipe("chem.concrete").setup(100, 100)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.powder_cement, 1), new RecipesCommon.ComparableStack(Blocks.GRAVEL, 8), new RecipesCommon.ComparableStack(Blocks.SAND, 8))
        ...
        this.register(new GenericRecipe("chem.concreteasbestos").setup(100, 100)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.powder_cement, 4), new RecipesCommon.OreDictStack(ASBESTOS.ingot(), (GeneralConfig.enableLBSM && GeneralConfig.enableLBSMSimpleChemsitry) ? 1 : 4), new RecipesCommon.ComparableStack(Blocks.SAND, 8))
                .inputFluids(new FluidStack(Fluids.WATER, 2_000))
                .outputItems(new ItemStack(ModBlocks.concrete_asbestos, 16)));

        this.register(new GenericRecipe("chem.ducrete").setup(150, 100)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.powder_cement, 4), new RecipesCommon.OreDictStack(FERRO.ingot()), new RecipesCommon.ComparableStack(Blocks.SAND, 8))
                .inputFluids(new FluidStack(Fluids.WATER, 2_000))
        ...
        this.register(new GenericRecipe("chem.asphalt").setup(100, 100)
                .inputItems(new RecipesCommon.ComparableStack(Blocks.GRAVEL, 2), new RecipesCommon.ComparableStack(Blocks.SAND, 6))
        ...
        this.register(new GenericRecipe("chem.batterylead").setup(100, 100)
                .inputItems(new RecipesCommon.OreDictStack(STEEL.plate(), 4),
                        new RecipesCommon.OreDictStack(PB.ingot(), 4))
                .inputFluids(new FluidStack(Fluids.SULFURIC_ACID, 8_000))
                .outputItems(new ItemStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_LEAD.ordinal())));
        this.register(new GenericRecipe("chem.batterylithium").setup(100, 1_000)
                .inputItems(new RecipesCommon.OreDictStack(LI.dust(), 12),
                        new RecipesCommon.OreDictStack(CO.dust(), 8),
                        new RecipesCommon.OreDictStack(ANY_PLASTIC.ingot(), 4))
                .inputFluids(new FluidStack(Fluids.OXYGEN, 2_000))
                .outputItems(new ItemStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_LITHIUM.ordinal())));
        this.register(new GenericRecipe("chem.batterysodium").setup(100, 10_000)
                .inputItems(new RecipesCommon.OreDictStack(NA.dust(), 24),
                        new RecipesCommon.OreDictStack(IRON.dust(), 24),
                        new RecipesCommon.OreDictStack(ANY_HARDPLASTIC.ingot(), 12))
                .outputItems(new ItemStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_SODIUM.ordinal())));
        this.register(new GenericRecipe("chem.batteryschrabidium").setup(100, 25_000)
                .inputItems(new RecipesCommon.OreDictStack(SA326.dust(), 24),
                        new RecipesCommon.OreDictStack(ANY_BISMOIDBRONZE.plateCast(), 8))
                .inputFluids(new FluidStack(Fluids.HELIUM4, 8_000))
                .outputItems(new ItemStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_SCHRABIDIUM.ordinal())));
        this.register(new GenericRecipe("chem.batteryquantum").setup(100, 100_000)
                .inputItems(new RecipesCommon.OreDictStack(BSCCO.wireDense(), 24),
                        new RecipesCommon.ComparableStack(ModItems.pellet_charged, 32),
                        new RecipesCommon.ComparableStack(ModItems.ingot_cft, 16))
                .inputFluids(new FluidStack(Fluids.PERFLUOROMETHYL_COLD, 8_000))
                .outputItems(new ItemStack(ModItems.battery_pack, 1, ItemBatteryPack.EnumBatteryPack.BATTERY_QUANTUM.ordinal()))
        ...
        this.register(new GenericRecipe("chem.deshcracked").setup(100, 100)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.powder_desh_mix))
                .inputFluids((GeneralConfig.enableLBSM && GeneralConfig.enableLBSMSimpleChemsitry) ?
        ...
        this.register(new GenericRecipe("chem.rocketfuel").setup(200, 100)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.solid_fuel, 2))
        ...
        this.register(new GenericRecipe("chem.dynamite").setup(50, 100)
                .inputItems(new RecipesCommon.ComparableStack(Items.SUGAR), new RecipesCommon.OreDictStack(KNO.dust()), new RecipesCommon.OreDictStack(KEY_SAND))
        ...
        this.register(new GenericRecipe("chem.tatb").setup(50, 5_000)
                .inputItems(new RecipesCommon.ComparableStack(ModItems.ball_tnt))
        ...
        this.register(new GenericRecipe("chem.polarized").setup(100, 500)
                ...
                .inputItems(new RecipesCommon.ComparableStack(Blocks.GLASS_PANE))
                .outputItems(DictFrame.fromOne(ModItems.part_generic, ItemEnums.EnumPartType.GLASS_POLARIZED, 16)));
        ...
        this.register(new GenericRecipe("chem.puf6").setup(200, 500)
                .inputItems(new RecipesCommon.OreDictStack(PU.dust()), new RecipesCommon.OreDictStack(F.dust(), 3))
                .inputFluids(new FluidStack(Fluids.WATER, 1_000))
                .outputFluids(new FluidStack(Fluids.PUF6, 900)));

        this.register(new GenericRecipe("chem.sas3").setup(200, 5_000)
                .inputItems(new RecipesCommon.OreDictStack(SA326.dust()), new RecipesCommon.OreDictStack(S.dust(), 2))
    ...
    public static HashMap<Object, Object> getRecipes() {
        ...
        for(GenericRecipe recipe : INSTANCE.recipeOrderedList) {
            ...
            if(recipe.inputItem != null) Collections.addAll(input, recipe.inputItem);
