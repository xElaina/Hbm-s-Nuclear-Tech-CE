...
public class ArcWelderRecipes extends SerializableRecipe {
  ...
  public void registerDefaults() {
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.wire_dense, 1, Mats.MAT_COPPER.id),
            100,
            10_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_IRON.id),
            100,
            100L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_STEEL.id),
            100,
            500L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_COPPER.id),
            200,
            1_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_TITANIUM.id),
            600,
            50_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_ZIRCONIUM.id),
            600,
            10_000L,
            new OreDictStack(ZR.plateCast(), 2)));
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_ALUMINIUM.id),
            300,
            10_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_TCALLOY.id),
            1_200,
            1_000_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_CDALLOY.id),
            1_200,
            1_000_000L,
            new FluidStack(Fluids.OXYGEN, 1_000),
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_TUNGSTEN.id),
            1_200,
            250_000L,
            new FluidStack(Fluids.OXYGEN, 1_000),
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_CMB.id),
            1_200,
            10_000_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.plate_welded, 1, Mats.MAT_OSMIRIDIUM.id),
            6_000,
            20_000_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            new OreDictStack(GRAPHITE.ingot(), 8)));
    recipes.add(
        new ArcWelderRecipe(
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.fuel_tank_small),
            60,
            1_000L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.fuel_tank_medium),
            100,
            2_000L,
            new OreDictStack(AL.plateCast(), 4),
            new OreDictStack(TI.plate(), 8),
            new ComparableStack(ModBlocks.steel_scaffold, 12)));
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.fuel_tank_large),
            200,
            5_000L,
            new OreDictStack(AL.plateWelded(), 8),
            new OreDictStack(BIGMT.plate(), 12),
            new ComparableStack(ModBlocks.steel_scaffold, 16)));

    // Missiles
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.missile_anti_ballistic),
            100,
            5_000L,
            new OreDictStack(ANY_HIGHEXPLOSIVE.ingot(), 3),
            new ComparableStack(ModItems.missile_assembly),
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            100,
            5_000L,
            new ComparableStack(ModItems.warhead_generic_small),
            new ComparableStack(ModItems.fuel_tank_small),
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            100,
            5_000L,
            new ComparableStack(ModItems.warhead_incendiary_small),
            new ComparableStack(ModItems.fuel_tank_small),
            new ComparableStack(ModItems.thruster_small)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            100,
            5_000L,
            new ComparableStack(ModItems.warhead_cluster_small),
            new ComparableStack(ModItems.fuel_tank_small),
            new ComparableStack(ModItems.thruster_small)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            100,
            5_000L,
            new ComparableStack(ModItems.warhead_buster_small),
            new ComparableStack(ModItems.fuel_tank_small),
            new ComparableStack(ModItems.thruster_small)));
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.missile_decoy),
            60,
            2_500L,
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            200,
            10_000L,
            new ComparableStack(ModItems.warhead_generic_medium),
            new ComparableStack(ModItems.fuel_tank_medium),
            new ComparableStack(ModItems.thruster_medium)));
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.missile_incendiary_strong),
            200,
            10_000L,
            new ComparableStack(ModItems.warhead_incendiary_medium),
            new ComparableStack(ModItems.fuel_tank_medium),
            new ComparableStack(ModItems.thruster_medium)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            200,
            10_000L,
            new ComparableStack(ModItems.warhead_cluster_medium),
            new ComparableStack(ModItems.fuel_tank_medium),
            new ComparableStack(ModItems.thruster_medium)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            200,
            10_000L,
            new ComparableStack(ModItems.warhead_buster_medium),
            new ComparableStack(ModItems.fuel_tank_medium),
            new ComparableStack(ModItems.thruster_medium)));
    recipes.add(
        new ArcWelderRecipe(
            new ItemStack(ModItems.missile_emp_strong),
            200,
            10_000L,
            new ComparableStack(ModBlocks.emp_bomb, 3),
            new ComparableStack(ModItems.fuel_tank_medium),
            new ComparableStack(ModItems.thruster_medium)));
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            300,
            25_000L,
            new ComparableStack(ModItems.warhead_incendiary_large),
            new ComparableStack(ModItems.fuel_tank_medium, 2),
            new ComparableStack(ModItems.thruster_medium, 4)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            300,
            25_000L,
            new ComparableStack(ModItems.warhead_cluster_large),
            new ComparableStack(ModItems.fuel_tank_medium, 2),
            new ComparableStack(ModItems.thruster_medium, 4)));
    recipes.add(
        new ArcWelderRecipe(
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            600,
            50_000L,
            new ComparableStack(ModItems.warhead_nuclear),
    ...
    recipes.add(
        new ArcWelderRecipe(
            ...
            600,
            50_000L,
            new ComparableStack(ModItems.warhead_mirv),
            new ComparableStack(ModItems.fuel_tank_large),
            new ComparableStack(ModItems.thruster_large, 3)));
    recipes.add(
        new ArcWelderRecipe(
            ...
            600,
            50_000L,
            new ComparableStack(ModItems.warhead_volcano),
            new ComparableStack(ModItems.fuel_tank_large),
            new ComparableStack(ModItems.thruster_large, 3)));
  ...
  public static class ArcWelderRecipe {
    ...
    public ArcWelderRecipe(
        ItemStack output, int duration, long consumption, FluidStack fluid, AStack... ingredients) {
    ...
    public ArcWelderRecipe(
        ItemStack output, int duration, long consumption, AStack... ingredients) {
