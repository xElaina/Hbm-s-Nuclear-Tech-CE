...
//        SR.ingot(ingot_strontium).dust(powder_strontium);
        ...
        for (NTMMaterial mat : Mats.orderedList) {
            if (mat.smeltable == NTMMaterial.SmeltingBehavior.SMELTABLE) {
                ...
                if (mat.autogen.contains(MaterialShapes.HEAVY_COMPONENT)) for (String name : mat.names)
                    OreDictionary.registerOre(MaterialShapes.HEAVY_COMPONENT.name() + name, new ItemStack(ModItems.heavy_component, 1, mat.id));
    ...
    public static class DictFrame {
        ...
        public String heavyComp() {
            return HEAVY_COMPONENT.name() + mats[0];
        }
        ...
        public String shell() {
            return SHELL.name() + mats[0];
        }

        public String pipe() {
            return PIPE.name() + mats[0];
        }
    ...
    public static class DictGroup {
        ...
        public String heavyComp() {
            return HEAVY_COMPONENT.name() + groupName;
        }
