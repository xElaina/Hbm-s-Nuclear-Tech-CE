...
public class SkeletonCreator implements IParticleCreator {
    ...
    public void makeParticle(World world, EntityPlayer player, TextureManager texman, Random rand, double x, double y, double z, NBTTagCompound data) {
        ...
        if (bonealizer != null) {
            ...
            for (BoneDefinition bone : bones) {
                ...
                skeleton.setPrevPAngle(bone.yaw);
                skeleton.setPAngle(bone.yaw);
                if(gib) {
                    skeleton.makeGib();
                    if(skel) {
                        skeleton.useTexture = ParticleSkeleton.texture;
                        skeleton.useTextureExt = ParticleSkeleton.texture_ext;
                    }
    ...
    public static Function<EntityLivingBase, BoneDefinition[]> BONES_BIPED = (entity) -> {
        ...
        return new BoneDefinition[] {
                ...
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX + leftarm.x, entity.posY + 1.125, entity.posZ + leftarm.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX - leftarm.x, entity.posY + 1.125, entity.posZ - leftarm.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX + leftleg.x, entity.posY + 0.375, entity.posZ + leftleg.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX - leftleg.x, entity.posY + 0.375, entity.posZ - leftleg.z),
        };
    };
    ...
    public static Function<EntityLivingBase, BoneDefinition[]> BONES_ZOMBIE = (entity) -> {
        ...
        return new BoneDefinition[] {
                new BoneDefinition(EnumSkeletonType.SKULL, -entity.rotationYawHead, entity.rotationPitch, entity.posX, entity.posY + 1.75, entity.posZ),
                new BoneDefinition(EnumSkeletonType.TORSO, -entity.renderYawOffset, 0, entity.posX, entity.posY + 1.125, entity.posZ),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, -90, entity.posX + leftarm.x + forward.x, entity.posY + 1.375, entity.posZ + leftarm.z + forward.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, -90, entity.posX - leftarm.x + forward.x, entity.posY + 1.375, entity.posZ - leftarm.z + forward.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX + leftleg.x, entity.posY + 0.375, entity.posZ + leftleg.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX - leftleg.x, entity.posY + 0.375, entity.posZ - leftleg.z),
        };
    ...
    public static Function<EntityLivingBase, BoneDefinition[]> BONES_VILLAGER = (entity) -> {
        ...
        return new BoneDefinition[] {
                ...
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, -45, entity.posX + leftarm.x + forward.x, entity.posY + 1.125, entity.posZ + leftarm.z + forward.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, -45, entity.posX - leftarm.x + forward.x, entity.posY + 1.125, entity.posZ - leftarm.z + forward.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX + leftleg.x, entity.posY + 0.375, entity.posZ + leftleg.z),
                new BoneDefinition(EnumSkeletonType.LIMB, -entity.renderYawOffset, 0, entity.posX - leftleg.x, entity.posY + 0.375, entity.posZ - leftleg.z),
        };
    ...
    public static void init() {
        ...
        skullanizer.put(EntityPlayerMP.class.getSimpleName(), BONES_BIPED);
