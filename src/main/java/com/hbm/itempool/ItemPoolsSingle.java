    ...
    public static void init() {
        ...
        new ItemPool(POOL_VAULT_RUSTY) {{
            this.pool = new WeightedRandomChestContentFrom1710[] {
                    ...
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.BMG50_FMJ.ordinal(), 24, 48, 1),
                    weighted(ModItems.ammo_standard, GunFactory.EnumAmmo.P9_JHP.ordinal(), 48, 64, 2),
