...
public class BobmazonOfferFactory {
	...
	public static void init() {
		...
		standard.add(new Offer(new ItemStack(ModBlocks.plant_flower, 1, PlantEnums.EnumFlowerPlantType.TOBACCO.ordinal()), Requirement.STEEL, 16, 9));
		standard.add(new Offer(new ItemStack(ModBlocks.plant_flower, 1, PlantEnums.EnumFlowerPlantType.NIGHTSHADE.ordinal()), Requirement.STEEL, 16, 3));
